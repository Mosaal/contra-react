...
export const toggleSwitchCva = cva(
  [
    "cr-border-black-000 checked:cr-bg-yellow-000 cr-rounded-4xl cr-relative cr-inline-flex cr-h-9 cr-w-15 cr-cursor-pointer cr-appearance-none cr-border-0.5 cr-bg-blue-100 disabled:cr-cursor-not-allowed disabled:cr-border-black-300 disabled:cr-bg-black-200 disabled:cr-shadow-black-300 checked:disabled:cr-bg-yellow-100",
    ...
    "before:cr-border-black-000 before:cr-ring-black-000 before:cr-absolute before:cr-left-2 before:cr-top-1/2 before:cr-h-4 before:cr-w-4 before:-cr-translate-y-1/2 before:cr-rounded-full before:cr-border-0.5 before:cr-bg-transparent before:cr-ring-0.5 before:cr-ring-offset-2 before:cr-ring-offset-white before:cr-transition-transform checked:before:cr-translate-x-6 disabled:before:cr-border-black-300 disabled:before:cr-ring-black-300",
  ],
  {
    variants: {
      raised: {
